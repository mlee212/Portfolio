  ...
  return (
    <div className="flex flex-row items-baseline border-b border-gray-100 dark:border-gray-800 max-w-3xl w-full mt-8">
      ...
      <div className="flex flex-col pl-3">
        <a
          className="font-medium text-gray-900 dark:text-gray-100 truncate w-60 sm:w-96 md:w-full text-lg md:text-md"
          href={track.songUrl}
          target="_blank"
        ...
        <p
          className="text-gray-500 mb-4 truncate w-60 sm:w-96 md:w-full text-lg md:text-md"
          color="gray.500"
        >
          {track.artist}
        </p>
