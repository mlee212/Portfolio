  ...
  return (
    <Container>
      <div className="flex flex-col justify-center items-center text-center">
        <div className="max-w-3xl mx-auto flex flex-col justify-center items-center px-6 py-16">
          ...
          <p className="text-text-light dark:text-text-dark mb-4 md:text-lg text-md z-10">
            ...
            <br />
            <br />
            Anyways, you've reached the 404, the end of the Jedi territory...I suggest you go back before you
