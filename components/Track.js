...
export default function Track(track) {
  return (
    <div className="flex flex-row items-baseline border-b-2 border-border-light dark:border-border-dark max-w-3xl w-full pt-6 transition duration-300 ease-in-out">
